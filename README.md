...
#### You can install the NuGet Package (FFmpeg UWP 4.1.3) from [here](https://www.nuget.org/packages/FFmpeg.UWP/ "here").
#### You can download the latest compiled libraries (FFmpeg UWP 4.1.3) from [here](https://github.com/ionutdanila/ffmpeg.UWP/releases "here").
